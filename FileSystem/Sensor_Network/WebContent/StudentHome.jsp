    	...
    	<div class="section-container">
	        <div class="container layouts">
	            <div class="row">
	                ...
	                <h3>Hello <%=uname %>, You have logged in as a <strong>STUDENT</strong></h3> <br>
	            	...
	            	<div class="col-sm-10 col-sm-offset-1">
	            		<div class="row">
		                	<div class="col-sm-4 layout-box">
			              	...
			              	<span class = "relative">
			                	<a href="StudentCourseCenter.jsp">
			        <ul class="caption-style-1">
			         	<li>		<img src="form-1/assets/img/backgrounds/1.jpg" alt="" style="opacity: 0.7;"/>
			        				<p class="absolute-text"><font color=#000000>COURSE CENTER<br><br>Lets you view all courses added</font></p>
			            <div class="caption">
						<div class="blur"></div>
						<div class="caption-text">
						<h1><strong>VIEW ALL COURSES</strong></h1>
						</div>
						</div>
						</li>
					</ul>
		                  ...
		                  <div class="col-sm-4 layout-box" style="float: right;">
			                     	...
			                     	<span class = "relative">
			                	<a href="StudentGrades.jsp">
			        <ul class="caption-style-1">
			         	<li>		<img src="form-1/assets/img/backgrounds/1.jpg" alt="" style="opacity: 0.7;"/>
			        				<p class="absolute-text"><font color=#000000>GRADE CENTER<br><br>Lets you view  Grades</font></p>
			            <div class="caption">
						<div class="blur"></div>
						<div class="caption-text">
						<h1><strong>GRADE CENTER</strong></h1>
		                    ...
		                    <div class="col-sm-4 layout-box" style="float: right;">
			                     	...
			                     	<span class = "relative">
			                	<a href="StudentSelectedCourses.jsp">
			        <ul class="caption-style-1">
			         	<li>		<img src="form-1/assets/img/backgrounds/1.jpg" alt="" style="opacity: 0.7;"/>
			        				<p class="absolute-text"><font color=#000000>VIEW SELECTED COURSES<br><br>Lets you view All your Selected Courses</font></p>
			            <div class="caption">
						<div class="blur"></div>
						<div class="caption-text">
						<h1><strong>VIEW SELECTED COURSES</strong></h1>
						</div>
						</div>
						</li>
					</ul>
