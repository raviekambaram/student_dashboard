...
<tbody>
		<%	do
            ...
            <tr>
               ...
               <td> <p data-placement="top" data-toggle="tooltip" title="Edit"><a href="Grading.jsp?courseID=<%= resultset.getString(1)%>" class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal"  ><span class="glyphicon glyphicon-ok"></span></a></p> </td>
           </tr> 
					<%}while(resultset.next());
}
else
{
	%> <h1>Sorry there are no courses available to display grades</h1>
<%}
        %>   		
