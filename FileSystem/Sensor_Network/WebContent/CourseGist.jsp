...
<title>Course Explanation</title>
<style>
.center {
    margin: auto;
    width: 60%;
...
String valid = (String)session.getAttribute("activesession");
            ...
            <%}
            		...
            		String enroll_status = request.getParameter("enrollstatus");
            		if(enroll_status!=null && enroll_status!="null")
            		{
            		if(enroll_status.equalsIgnoreCase("success"))
            		{
            		%>
            		<div class="alert alert-success">
            		  <strong>Course Successfully Added to catalog Check your <a href="StudentSelectedCourses.jsp">SELECTED COURSES</a> to view this course.</strong>
            		</div>

            		<%	
            		}
            		else if(enroll_status.equalsIgnoreCase("danger"))
            		{
            		%>
            		<div class="alert alert-danger">
            		  <strong>You are already registered to this course. Check your <a href="StudentSelectedCourses.jsp">SELECTED COURSES</a> to view this course.</strong>
            		</div>

            		<%	
            		}

            		else if(enroll_status.equalsIgnoreCase("failure"))
            		{
            		%>
            		<div class="alert alert-danger">
            		  <strong>Something Wrong With Enrolling. Please try again after sometime.</strong>
            		</div>
...
<hr>
<div class="center"> ENROLL:</div>
<div class="center"> <a type="button" href="EnrollCourse?courseID=<%=courseID %>" class="btn btn-info btn-block">ADD COURSE TO CATALOG</a>  
 </div>
<hr>
<%}
            	else
