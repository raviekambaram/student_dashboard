 ...
 <div class="table-responsive">
    ...
    <% 	
    	...
    	String userID =(String) Sess.getAttribute("loggedinUser");
            ...
            ResultSet resultset = db.getAllCourseInfo();
...
<tbody>
		<%	do
            ...
            <tr>
               ...
               <td> <p data-placement="top" data-toggle="tooltip" title="Edit"><a href="CourseGist.jsp?courseID=<%= resultset.getString(1)%>" class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal"  ><span class="glyphicon glyphicon-ok"></span></a></p> </td>
           </tr> 
